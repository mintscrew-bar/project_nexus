...
import { X, Menu, Home, Swords, Trophy, Users, MessageSquare, Settings, User, FlaskConical, ExternalLink, Shield, Moon, Sun, BookOpen, FileText } from 'lucide-react';
...
export function MobileMenu({ className }: MobileMenuProps) {
  ...
  return (
    <div className={cn('min-[1321px]:hidden', className)}>
      {/* Menu Button */}
      <button
