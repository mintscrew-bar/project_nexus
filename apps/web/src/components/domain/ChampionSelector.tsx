...
export function ChampionSelector({
  ...
  const handleKeyDown = useCallback(
    (e: React.KeyboardEvent) => {
      if (
        ...
        e.preventDefault();
        const firstUnselected = displayedChampions.find(
  ...
  return (
    <div>
      ...
      {/* ── 챔피언 그리드 ── */}
      <div
        className="grid grid-cols-6 sm:grid-cols-7 md:grid-cols-8 gap-1.5 max-h-[320px] overflow-y-scroll pr-1 scrollbar-thin"
