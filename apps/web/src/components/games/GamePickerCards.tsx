...
export function GamePickerCards() {
  ...
  return (
    ...
    >
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-8 z-0 flex items-center justify-between px-0 text-[clamp(8rem,18vw,18rem)] font-black italic leading-none tracking-[0.02em] text-white/[0.08]">
        <span>LOCK IN</span>
        <span>FULL SEND</span>
      </div>
