...
| # | 작업 | 커밋 |
|---|------|------|
| Task 1 | Prisma 스키마 확장 (ClanInvitation/Announcement/ActivityLog) | edee4db |
| Task 2 | DB 스키마 푸시 | edee4db |
| Task 3 | 백엔드 채팅 커서 페이지네이션 + 메시지 소프트 삭제 | 38cf574 |
| Task 4 | 백엔드 활동 로그 (logActivity 헬퍼 + getActivityLogs) | 38cf574 |
| Task 5 | 백엔드 초대/가입 요청 시스템 (8개 메서드 + 엔드포인트) | 38cf574 |
| Task 6 | 백엔드 공지사항 CRUD + Socket 브로드캐스트 | 38cf574 |
| Task 7 | 백엔드 클랜 통계 API + listClans sort 옵션 | 38cf574 |
| Task 8 | 프론트엔드 api-client + socket-client 확장 | 2584f82 |
| Task 9 | 프론트엔드 clan-store 확장 (cursor/unread/announcements) | 2584f82 |
| Task 10 | 클랜 브라우저 카드 리디자인 (스켈레톤/배지/프로그레스바) | 230f2c7 |
