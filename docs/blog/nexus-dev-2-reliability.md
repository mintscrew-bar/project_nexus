...
솔직히 말하면, 여기에는 사명감 같은 거창한 이유만 있지는 않았습니다. 장애가 날 때마다 서버에 붙어서 상태를 확인하고 하나하나 수동으로 대응하는 게 **너무 귀찮았던 것**도 절반은 됩니다. 같은 문제를 두 번 손으로 고치고 싶지 않아서, 이번 기회에 아예 손 뗄 수 있는 만큼 자동화해뒀습니다.
