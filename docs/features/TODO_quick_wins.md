...
- [x] Task 1: [P0] 비로그인 시 `/api/auth/refresh` 401 제거
...
- [x] Task 7: [Security] `X-Powered-By` 헤더 제거 + AdSense `data-cfasync` 제거
